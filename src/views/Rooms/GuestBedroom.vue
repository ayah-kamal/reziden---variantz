<template>
  <div>
    ...
    <CRow class="rowStyle">
        ...
        <img class = "deviceImage" src="guestBedroom.jpg" alt="">
...
<CRow class="rowStyle">
        ...
        <img  class = "deviceImage" src="https://www.did.ie/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/4/3/43pus6504_3.jpg" alt="">
...
<CRow class="rowStyle">
   ...
   <div class="onoffswitch">
    ...
    <label class="onoffswitch-label" for="myonoffswitch5">
      ...
      <CRow class="rowStyle">
        <CCard>
          <h4 class = "title">Alarm</h4>
        <img  class = "deviceImage" src="alarm.jpg" alt="">
...
.onoffswitch {
    position: relative; width: 81px; margin-left: 75px; margin-top: 5px;
...
.onoffswitch-inner:before {
    content: "ON";
    padding-left: 10px;
    background-color: #4F7FBF; color: #FFFFFF;
}
...
.onoffswitch-switch {
    display: block; width: 26px; height: 26px; margin: 9px;
    background: #FFFFFF;
